              ...
              <ul>
                {itemsTransaction.map((item, index) => (
                  <li key={index} className="mb-2">
                    <div className="flex flex-grow h-48 w-full ">
                      <span className="flex items-center ml-2 mr-2">
                        <img
                          src={item.imageUrl}
                          alt="Landing Page"
                          className="h-24 w-max-[96px] border rounded-3xl shadow-lg"
                        />
                      </span>
                      <div className="flex flex-col ml-4 mr-4 mt-4 mb-4 items-start">
                        <p className="text-3xl font-bold text-ellipsis overflow-hidden left-0">
                          {item.title}
                        </p>
                        <h3
                      ...
                      <div className="flex flex-grow ml-2 mr-2 mt-4 mb-4 justify-end">
                        <div
                        ...
                        <div className="flex items-end mb-4 mr-4">
                          <input
                            ...
                            value={item.qty}
                            disabled
                            className="mt-1 block w-20 px-3 py-2 font-bold bg-white border-2 border-slate-900 rounded-md text-lg shadow-sm placeholder-slate-400
